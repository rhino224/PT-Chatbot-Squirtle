        ...
        try:
            ...
            if self.response is None:
                self.response = palm.chat(
                    ...
                    context='Be professional and think outside the box',
...
class ChatbotGUI:  ##################################################################
    ...
    def init_chatbot_gui(self):
        ...
        self.chat_entry.configure(background="blue", foreground="black", font=("Helvetica", 8, "bold"))
        ...
        button_frame_2 = ttk.Frame(self.frame)
        button_frame_2.grid(row=1, column=2, padx=5)

        # Create Toggle Buttons for Mode
        mode_label = ttk.Label(button_frame_2, text="Select Mode:")
        mode_label.grid(row=0, column=0, padx=5, pady=5, sticky="w")

        normal_mode_button = ttk.Radiobutton(button_frame_2, text="Normal Mode", variable=self.mode,
                                             value="Normal")
        normal_mode_button.grid(row=1, column=0, padx=5, pady=5, sticky="w")

        pt_mode_button = ttk.Radiobutton(button_frame_2, text="PT Mode", variable=self.mode,
                                         value="PT Mode")
        pt_mode_button.grid(row=2, column=0, padx=5, pady=5, sticky="w")
...
def run_gui():
    ...
    root.style.configure('TLabel', foreground="#d6d6d6")
    root.style.configure('header.TLabel', font=('Helvetica', 20, 'bold'))
    root.style.configure('TLabel', font=('Helvetica', 14, 'bold'))
    root.style.configure('TNotebook', background="#343638", foreground="blue")
